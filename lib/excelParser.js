 ...
 *
 * Runs entirely in the browser using SheetJS (xlsx library).
 * Parses the SO99+ export format, extracting columns by HEADER NAME
 * (not by position) so the tool works even if column order changes.
 *
