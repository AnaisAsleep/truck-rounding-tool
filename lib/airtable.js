...
// NOTE: IDs were originally swapped — corrected here
const PALLETIZATION_TABLE_ID = process.env.PALLETIZATION_TABLE_ID || 'tbl6Vr4XwyNhLVsMX';
const COST_TABLE_ID = process.env.COST_TABLE_ID || 'tblY2PxdLq84p8Erc';
