...
export function runRounding(validRows, prio4Rows, costMap, weekNum, year) {
  ...
  // ── Step 4: Build and auto-confirm pass-through trucks ─────────────
  ...
  return {
    confirmedTrucks: [...confirmedTrucks, ...passThroughConfirmed],
    borderlineTrucks,
    cutTrucks,
