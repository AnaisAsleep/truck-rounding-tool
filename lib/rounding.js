...
export function runRounding(validRows, prio4Rows, costMap, weekNum, year, isBedsAndAcc = false) {
  ...
  // For FENN_EE / FEN1_EE, these MTS SKUs are eligible for Prio 4 top-up.
  // All other FENN SKUs are Made-to-Order (MTO) and may not use Index 1 for HA_DE.
  const FENN_MTS_SKUS = new Set([
