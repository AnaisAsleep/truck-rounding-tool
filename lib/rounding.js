 ...
 */
export function finalizeResults(roundingResults, userDecisions, _forceKeptVSNs, transportModeDecisions, cutLineNotes = {}, unmatchedRows = []) {
  ...
  const keepTruck = (truck, action, luReason, label) => {
    finalConfirmed.push({
      ...
      transportUnitOverride: action === 'van' ? 'Van' : action === '20ft' ? '20ft Container' : null,
    });
  };
