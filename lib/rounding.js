  ...
  for (const mr of milkRunCandidates) {
    ...
    for (const stop of mr.stops) {
      ...
      confirmedMilkRunTrucks.push({
        ...
        costPerPiece: action === '20ft' && mr.costPerPiece != null
          ? mr.costPerPiece * CONTAINER_20FT_FRACTION
          : mr.costPerPiece,
        transportCost: action === '20ft' && mr.transportCost != null
          ? mr.transportCost * CONTAINER_20FT_FRACTION
          : mr.transportCost,
...
export function finalizeResults(roundingResults, userDecisions, _forceKeptVSNs, transportModeDecisions, cutLineNotes = {}, unmatchedRows = [], truckAdditions = {}) {
  ...
  const keepTruck = (truck, action, luReason, label) => {
    ...
    finalConfirmed.push({
      ...
      transportCost: action === '20ft' && truck.transportCost != null
        ? truck.transportCost * CONTAINER_20FT_FRACTION
        : truck.transportCost,
      costPerPiece: action === '20ft' && truck.costPerPiece != null
        ? truck.costPerPiece * CONTAINER_20FT_FRACTION
        : truck.costPerPiece,
    });
  };
